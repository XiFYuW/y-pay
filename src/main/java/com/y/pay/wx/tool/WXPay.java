...
import com.y.pay.wx.tool.WXPayConstants.SignType;
...
//            reqData.put("sign_type", WXPayConstants.HMACSHA256);
    ...
    /**
     * 作用：转账
     * 场景：用于企业向微信用户个人付款 目前支持向指定微信用户的openid付款
     * 其他：需要证书
     * @param reqData 向wxpay post的请求数据
     * @return API返回数据
     * @throws Exception
    ...
    public Map<String, String> transfers(Map<String, String> reqData) throws Exception {
        return this.transfers(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
     ...
     * @throws Exception
     */
    public Map<String, String> transfers(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
